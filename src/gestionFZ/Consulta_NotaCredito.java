...
public class Consulta_NotaCredito extends javax.swing.JFrame {
  ...
  String fil = "";
  String sta = "T";
  String format = " %1$-10s %2$-10s %3$-10s %4$-10s %5$-35s %6$14s\n";

  double tnc = 0;

  Registro_NotaCredito ctrlN1;
  Registro_PagosClientes ctrlN2;

  public Consulta_NotaCredito(Registro_NotaCredito ctrl, String cox) {
    ctrlN1 = ctrl;
    coc = cox;
    ConsultaNotaNotCred(1);
  }

  public Consulta_NotaCredito(Registro_PagosClientes ctrl, String cox) {
    ctrlN2 = ctrl;
    coc = cox;
    ConsultaNotaNotCred(2);
  }

  public void ConsultaNotaNotCred(int opx) {
    ...
    String vax = String.format(format, " NotCred", " Fecha", "Not Ent", "Recibo", "Cliente", "T.Not/Ent");
    jTiT.setText(vax);
  ...
  public void Seleccion(int tec) {
    ...
    if (Ref.length() >= 20) {
      ...
      if (isNumeric(rec)) {
        ...
        if (opc == 1) {
          ctrlN1.recibeNotaCredito(nne);
        }
        if (opc == 2) {
          ctrlN2.recibeNotaCredito(nne);
        }
        conNcr.dispose();
      }
    }
  ...
  public void ListaDatos() {
    ...
    try {
      ...
      String vax = "";
      if (sta.equals("P")) {
        vax = " and ncr not in (select nno from recibocobroD where tpd=1) ";
      } else {
        if (sta.equals("C")) {
          vax = " and ncr  in (select nno from recibocobroD where tpd=1) ";
        }
      }
      String sql = "SELECT ncr,nne,fnc,"
              + "(select nrc from recibocobroD y where y.tpd=1 and nno=ncr FETCH FIRST 1 ROWS ONLY ) nrc,"
              + "(select nom from clientes where clientes.coc=notaCred.coc) noc,tnc "
              + "FROM notacred "
      ...
      while (rs.next()) {
        ...
        vax = String.format(format, ncr, ymd_dmyc(fnc), nne, nrx, noc, MtoEs(tnc, 0));
      ...
      Logger.getLogger(Consulta_NotaCredito.class.getName()).log(Level.SEVERE, null, ex);
    }
    txtBus.requestFocus();
  }
  ...
  private void initComponents() {
    ...
    jLabel3.setText("CONSULTA NOTAS DE CREDITO");
    ...
    jToT.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
    ...
    jLabel4.setText("Total  Documentos");
    ...
    cbTip.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pendientes", "Cerradas Rec Cobro", "Todas" }));
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
              .addComponent(cbTip, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
              .addGroup(layout.createSequentialGroup()
                .addComponent(txtFeh, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(Cliente, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
          ...
          .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
            .addComponent(btnSel, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(Consulta_NotaCredito.class
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      Registro_NotaCredito ctrl = new Registro_NotaCredito();

      public void run() {
        new Consulta_NotaCredito(ctrl, "").setVisible(true);
      }
    });
  }
